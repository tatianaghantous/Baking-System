...
namespace TS.Persistence.Helper;
...
public class AccountHelper
{
    ...
    public AccountHelper(ITransactionsDbContext context, ICurrentUser currentUser)
    {
        _context = context;
    ...
    private ExpressionStarter<Account> GetFilters()
    {
        ...
        {
            pd = pd.And(x => x.Guid == _currentUser.Id);
        }

        return pd;
    }

    public bool HasAccess(Account desiredAccount)
    {
